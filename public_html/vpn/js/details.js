...
$('body').live("focus","input",function(event) { 
	if( !event ) event = this;
...
$("input").live('focusout',function(event){
	if( !event ) event = this;
	console.log('################');
	console.log('unfocus');
	id2 = event.target.id;
...
function addRow() {
	...
	var		newInput1 = document.createElement('input'); newInput1.id = id+'0'; newInput1.name = 'hurdler:id'; newInput1.size = '2'; newInput1.value = id;
	cell1.appendChild(newInput1);
	var		newInput2 = document.createElement('input'); newInput2.id = id+'1';	newInput2.name = 'hurdler:name'; newInput2.size = '4'; newInput2.value = '';
	cell2.appendChild(newInput2);
	var		newInput3 = document.createElement('input'); newInput3.id = id+'2';	newInput3.name = 'hurdler:surname'; newInput3.size = '4'; newInput3.value = '';
	cell3.appendChild(newInput3);
	var		newInput4 = document.createElement('input'); newInput4.id = id+'3';	newInput4.name = 'hurdler:address'; newInput4.size = '24'; newInput4.value = '';
	cell4.appendChild(newInput4);
	var		newInput5 = document.createElement('input'); newInput5.id = id+'4';	newInput5.name = 'hurdler:phone'; newInput5.size = '10'; newInput5.value = '';
	cell5.appendChild(newInput5);
	var		newInput6 = document.createElement('input'); newInput6.id = id+'5';	newInput6.name = 'hurdler:email'; newInput6.size = '25'; newInput6.value = '';
	cell6.appendChild(newInput6);
	var		newInput7 = document.createElement('input'); newInput7.id = id+'6';	newInput7.name = 'hurdler:dob'; newInput7.size = '8'; newInput7.value = '';
	cell7.appendChild(newInput7);
	var		newInput8 = document.createElement('input'); newInput8.id = id+'7';	newInput8.name = 'hurdler:sex'; newInput8.size = '2'; newInput8.value = '';
	cell8.appendChild(newInput8);
	var		newInput9 = document.createElement('input'); newInput9.id = id+'8';	newInput9.name = 'hurdler:previous_best'; newInput9.size = '7'; newInput9.value = '';
...
function addWatt(id)
{
	...
	var cell9=row.insertCell(8);
	var cell10=row.insertCell(9);
	var		newInput1 = document.createElement('input'); newInput1.id = id+'0'; newInput1.name = 'watt:member_id'; newInput1.size = '2'; newInput1.value = id;
	cell1.appendChild(newInput1);
	var		newInput2 = document.createElement('input'); newInput2.id = id+'1';	newInput2.name = 'watt:name'; newInput2.size = '7'; newInput2.value = '';			
	cell2.appendChild(newInput2);
	var		newInput3 = document.createElement('input'); newInput3.id = id+'2';	newInput3.name = 'watt:surname'; newInput3.size = '6'; newInput3.value = '';
	cell3.appendChild(newInput3);
	var		newInput4 = document.createElement('input'); newInput4.id = id+'3';	newInput4.name = 'watt:address'; newInput4.size = '13'; newInput4.value = '';
	cell4.appendChild(newInput4);
	var		newInput5 = document.createElement('input'); newInput5.id = id+'4';	newInput5.name = 'watt:dob'; newInput5.size = '7'; newInput5.value = '';
	cell5.appendChild(newInput5);
	var		newInput6 = document.createElement('input'); newInput6.id = id+'5';	newInput6.name = 'watt:phone'; newInput6.size = '8'; newInput6.value = '';
	cell6.appendChild(newInput6);
	var		newInput7 = document.createElement('input'); newInput7.id = id+'6';	newInput7.name = 'watt:email'; newInput7.size = '18'; newInput7.value = '';
	cell7.appendChild(newInput7);
	var		newInput8 = document.createElement('input'); newInput8.id = id+'7';	newInput8.name = 'watt:position'; newInput8.size = '8'; newInput8.value = '';
	cell8.appendChild(newInput8);
	var		newInput9 = document.createElement('input'); newInput9.id = id+'8';	newInput9.name = 'watt:shirt_num'; newInput9.size = '5'; newInput9.value = '';
	cell9.appendChild(newInput9);
