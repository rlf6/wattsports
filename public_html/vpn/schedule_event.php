...
<tr  align='center'>
	...
	<select  name='type'  width='170px' style='width:170px;'>
		<option value='wattball'>Wattball(Round Robin)</option>
		<option value='hurdle 400m (M)'>Hurdles 400m (M)</option>
		<option value='hurdle 400m (F)'>Hurdles 400m (F)</option>
		<option value='hurdle 200m (M)'>Hurdles 200m (M)</option>
		<option value='hurdle 200m (F)'>Hurdles 200m (F)</option>
		<option value='hurdle 100m (M)'>Hurdles 100m (M)</option>
		<option value='hurdle 100m (F)'>Hurdles 100m (F)</option>
