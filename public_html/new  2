            ...
            <h1 class="title"><?php the_title(); ?></h1>
				...
				<table>
					...
					for($i = 0; $teams[$i]; $i++)
					{
						...
						echo '<a class="fancybox"  data-fancybox-type="iframe"  href="http://www.wattsports.co.uk/teams_details/?id='.$teams[$i]['assoc_id'].'" id="'.$teams[$i]['assoc_id'].'" )" ><img src="'. $teams[$i]['badge'] .'" title="'.$teams[$i]['team_name'].'" height="128" width="128" /></a>
						</td>';
						if($i != 0 && $i%4 ==0)echo "</tr>";
						$no++;
					}?>
