...
?>
    ...
    <div id="content" class="col-full">
    	<div id="main-sidebar-container">    
			...
			<div class="scroll">
			<table class='watt' style="border:2px solid grey;">
			<tr style="border:2px solid grey;"><th>Date</th><th>Kick-off</th><th colspan=4>Match</th><th>Location</th></tr>
<?php
	...
	while($row = mysql_fetch_assoc($result))
	{
		...
		echo '<td class="padding2"><img src="'.$query_team['badge'].'" height="50" width="50"</img><td>';
		...
		echo $query_team['team_name'].'</td><td class="padding2"><img src="'.$query_team['badge'].'" height="50" width="50"</img></td>';
