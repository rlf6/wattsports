...
<div class="center_div" border="2px solid">
				...
				<ul id="board" class="nav nav-pills nav-stacked" style="height:auto;">
				<?
				...
				echo"<li id='$rank' name='$time' ><a href=".$url." style=' text-indent:-15px; padding-left:25px;'>".$rank.": ".$comment."  </a></li>";
				}
				?>
			</ul>
			</td></tr></table>
