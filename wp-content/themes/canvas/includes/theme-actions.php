...
- Enqueue Dynamic CSS
- Adjust the WooFramework interface to fit all of Canvas' menu items
...
add_action( 'admin_print_styles-toplevel_page_woothemes', 'woo_adjust_wf_interface' );

if ( ! function_exists( 'woo_adjust_wf_interface' ) ) {
function woo_adjust_wf_interface () {
	echo '<style type="text/css">body #woo_container #content { min-height: 780px; }</style>' . "\n";
} // End woo_adjust_wf_interface()
}
